export type PushFirebaseWebConfig = {
  apiKey: string;
  authDomain: string;
  projectId: string;
...
export function getPushFirebaseWebConfig(): PushFirebaseWebConfig | null {
  ...
  const messagingSenderId =
    process.env.NEXT_PUBLIC_PUSH_FIREBASE_MESSAGING_SENDER_ID?.trim();
...
export function getMonitorWebUrl(): string {
